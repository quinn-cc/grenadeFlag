BZFlag Server Plugin: grenadeFlag
================================================================================
...
grenadeFlag directory to a new name, and then manually replace grenadeFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin grenadeFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin grenadeFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin grenadeFlag,<configfilename>
For example:
  -loadplugin grenadeFlag,/path/to/my/sampleplugin.cfg
